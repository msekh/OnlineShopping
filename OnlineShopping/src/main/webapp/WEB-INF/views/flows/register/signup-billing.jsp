			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form method="POST" modelAttribute="billing"
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="division">Division</label>
							<div class="col-md-8">
								<sf:input type="text" path="division" class="form-control"
									placeholder="Enter Division Name" />
								<sf:errors path="division" cssClass="help-block" element="em" />
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-8">
								<!-- Submit button for moving personal  -->
								<button type="submit" name="_eventId_personal"
									class="btn btn-primary">
									<span class="glyphicon glyphicon-chevron-left"></span> Back -
									Personal
								</button>
								<!-- Submit button for moving confirm  -->
